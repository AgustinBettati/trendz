...
public class PostVoteTests  extends TestUtils {
    ...
    public void testUpvotePost() throws URISyntaxException {
       ...
       // Assert.assertTrue(post.get().getUpvotes().size()==1);
        ...
        Assert.assertEquals(user.get().getUpvotedPosts().get(0).getId(),response.getBody().getPostId());
        Assert.assertEquals(post.get().getUpvotes().get(0).getId(),response.getBody().getUserId());
        Assert.assertEquals(user.get().getEmail(),"admin@gmail.com");
        //Assert.assertTrue(user.get().getUpvotedPosts().size()==1);
    ...
    public void testDownvotePost() throws URISyntaxException {
        ...
        Assert.assertEquals(user.get().getDownvotedPosts().get(0).getId(),response.getBody().getPostId());
        Assert.assertEquals(post.get().getDownvotes().get(0).getId(),response.getBody().getUserId());
        Assert.assertEquals(user.get().getEmail(),"admin@gmail.com");
