...
public class VoteDeleteTests  extends TestUtils {
    ...
    @Test
    public void testDeletePostWhenPostIsDownVoted() throws URISyntaxException {
        ...
        final String url = "http://localhost:" + randomServerPort + "/vote/"+postResponse.getBody().getId()+"/upvote";
        URI uri = new URI(url);
